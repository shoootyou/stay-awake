...
tray-mode-zen = マウス禅
tray-mode-circle = マウス円形
tray-accessibility-ok = アクセシビリティ OK
tray-grant-accessibility = アクセシビリティを許可
tray-settings = 設定…
tray-quit = 終了
tray-tooltip-active = Stay Awake — アクティブ
tray-tooltip-inactive = Stay Awake — 非アクティブ

# 設定ウィンドウ
settings-title = Stay Awake 設定
...
settings-grant-btn = アクセスを許可

# スケジュール
schedule-label = スケジュール
schedule-enabled = スケジュールを有効化
schedule-start = 開始時刻
schedule-end = 終了時刻
schedule-days = 有効な曜日
schedule-mon = 月
